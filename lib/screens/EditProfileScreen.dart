  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: InkWell(
        onTap: (){
      launchScreen(context, DashboardScreen(index: 3,),pageRouteAnimation: PageRouteAnimation.Slide);
    }, child: Icon(
          Icons.arrow_back,size: 20,weight: 25,color: Colors.white,
        ),),
                ...
                children: [
                  ...
                  if (widget.isGoogle)
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(language.updateVehicleInfo, style: boldTextStyle()),
                        SizedBox(height: 8),
