              ...
              children: [
                ...
                if (riderModel!.couponData != null &&
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      printAmountWidget(
                          amount: riderModel!.couponDiscount!
                ...
                riderModel!.tips != null
                    ? riderModel!.extraChargesAmount != null
                        ? riderModel!.surgeCharge != null &&
                                riderModel!.surgeCharge! > 0
                            ? totalCount(
                                title: language.total,
                                amount: riderModel!.subtotal! +
                                    riderModel!.tips! +
                                    riderModel!.extraChargesAmount! +
                                    riderModel!.surgeCharge!,
                                isTotal: true)
                            : totalCount(
                                title: language.total,
                                amount: riderModel!.subtotal! +
                        ...
                        : riderModel!.surgeCharge != null &&
                            ...
                            : totalCount(
                                title: language.total,
                                amount:
                                    riderModel!.subtotal! + riderModel!.tips!,
                                isTotal: true)
                    : riderModel!.extraChargesAmount != null
                        ? riderModel!.surgeCharge != null &&
                                riderModel!.surgeCharge! > 0
                ...
                payment != null && payment!.driverTips != 0
                    ? riderModel!.surgeCharge != null &&
                        ...
                        ? totalCount(
                            ...
                            amount: riderModel!.subtotal! +
                                payment!.driverTips! +
                                riderModel!.surgeCharge!+(riderModel!.perMinuteWaitingCharge??0)+(riderModel!.extraChargesAmount??0),
                            isTotal: true)
                        : totalCount(
                            title: language.total,
                            amount:
                                riderModel!.subtotal! + payment!.driverTips!+(riderModel!.perMinuteWaitingCharge??0)+(riderModel!.extraChargesAmount??0),
                            isTotal: true)
                    : riderModel!.surgeCharge != null &&
                            riderModel!.surgeCharge! > 0
                        ? totalCount(
                        ...
                        : totalCount(
                            title: language.total,
                            amount: riderModel!.subtotal!+(riderModel!.perMinuteWaitingCharge??0)+(riderModel!.extraChargesAmount??0),
                            isTotal: true),
