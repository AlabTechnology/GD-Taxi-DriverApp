    ...
    return Container(
      ...
      Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          totalCount(title: language.amount, amount: riderModel!.subtotal,space:8),
          if (riderModel!.couponData != null && riderModel!.couponDiscount != 0)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(language.couponDiscount, style: secondaryTextStyle()),
                printAmountWidget(amount: riderModel!.couponDiscount!.toStringAsFixed(digitAfterDecimal), size: 14, color: Colors.green),
              ],
            ),
          ...
          totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.tips! + riderModel!.extraChargesAmount!, isTotal: true)
              :
          riderModel!.surgeCharge != null && riderModel!.surgeCharge! > 0?
          totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.tips!+riderModel!.surgeCharge!, isTotal: true):
          totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.tips!, isTotal: true)
              : riderModel!.extraChargesAmount != null
              ?
          riderModel!.surgeCharge != null && riderModel!.surgeCharge! > 0?
          totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.extraChargesAmount!+riderModel!.surgeCharge!, isTotal: true):
          totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.extraChargesAmount!, isTotal: true)
              :
          riderModel!.surgeCharge != null && riderModel!.surgeCharge! > 0?
          totalCount(title: language.total, amount: riderModel!.subtotal!+riderModel!.surgeCharge!, isTotal: true):
        ...
        children: [
          ...
          riderModel!.subtotal! <= riderModel!.minimumFare!
            ...
            children: [
              ...
              totalCount(title: language.minutePrice, amount: riderModel!.perMinuteDriveCharge, space: riderModel!.perMinuteWaitingCharge != 0 ? 8 : riderModel!.surgeCharge!=0?8: 0),
          ...
          riderModel!.tips != null
              ? riderModel!.surgeCharge != null && riderModel!.surgeCharge! > 0
              ? totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.tips! + riderModel!.surgeCharge!+(riderModel!.perMinuteWaitingCharge??0)+(riderModel!.extraChargesAmount??0), isTotal: true)
              : totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.tips!+(riderModel!.perMinuteWaitingCharge??0)+(riderModel!.extraChargesAmount??0), isTotal: true)
              : riderModel!.surgeCharge != null && riderModel!.surgeCharge! > 0
              ? totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.surgeCharge!+(riderModel!.perMinuteWaitingCharge??0)+(riderModel!.extraChargesAmount??0), isTotal: true)
              : totalCount(title: language.total, amount: riderModel!.subtotal!+(riderModel!.perMinuteWaitingCharge??0)+(riderModel!.extraChargesAmount??0), isTotal: true),
          // riderModel!.tips != null
          //     ? totalCount(title: language.total, amount: riderModel!.subtotal! + riderModel!.tips!, isTotal: true)
          //     : totalCount(title: language.total, amount: riderModel!.subtotal, isTotal: true),
        ],
