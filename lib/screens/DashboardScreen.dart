...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  void init() async {
    if (sharedPref.getDouble(LATITUDE) != null &&
      ...
      driverLocation = LatLng(
          sharedPref.getDouble(LATITUDE)!, sharedPref.getDouble(LONGITUDE)!);
    }
    ...
    destinationIcon = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5),
        Platform.isIOS ? DestinationIOSIcon : DestinationIcon);
  ...
  Future<void> getCurrentRequest() async {
    await getCurrentRideRequest().then((value) async {
      ...
      if (value.onRideRequest != null) {
        ...
        if (value.estimated_price != null && value.estimated_price.isNotEmpty) {
          try {
            ...
            if (rideHasBid == 1 || value.ride_has_bids == 1) {
              estimatedTotalPrice =
                  num.tryParse(value.onRideRequest!.subtotal.toString());
            }
            estimatedDistance =
        ...
        if (value.onRideRequest != null &&
            value.onRideRequest!.multiDropLocation != null) {
          servicesListData!.multiDropLocation =
              value.onRideRequest!.multiDropLocation;
        }
  ...
  getNewRideReq(int? riderID, {bool? refresh}) async {
    ...
    if (refresh != true) {
      if (servicesListData != null &&
          servicesListData!.status == NEW_RIDE_REQUESTED) return;
    }
    await rideDetail(rideId: riderID).then((value) async {
      ...
      if (value.data!.status == NEW_RIDE_REQUESTED ||
          value.data!.status == BID_REJECTED) {
        try {
          ...
          if (value.estimated_price != null &&
              value.estimated_price.isNotEmpty) {
            try {
              estimatedTotalPrice = num.tryParse(
                  value.estimated_price[0]['total_amount'].toString());
              estimatedDistance =
    ...
    try {
      ...
      if (servicesListData != null &&
        ...
        for (int k = 0; k < x.length; k++) {
          if (servicesListData!.multiDropLocation!
                      .where((element) => element.drop == x[k]) !=
                  null &&
              servicesListData!.multiDropLocation!
                  .where((element) => element.drop == x[k])
                  .isNotEmpty &&
              servicesListData!.multiDropLocation!
                      ...
                      .droppedAt ==
                  null) {
            lat1 = servicesListData!.multiDropLocation!
                .where((element) => element.drop == x[k])
                .first
                .lat;
            lng1 = servicesListData!.multiDropLocation!
                .where((element) => element.drop == x[k])
                .first
                .lng;
            break;
      ...
      if (lat1 != null && lng1 != null) {
        ...
        var result = await polylinePoints.getRouteBetweenCoordinates(
          ...
          request: PolylineRequest(
              origin: PointLatLng(
                  driverLocation!.latitude, driverLocation!.longitude),
              destination: servicesListData != null &&
                      servicesListData!.status != IN_PROGRESS
                  ? PointLatLng(
                      double.parse(servicesListData!.startLatitude.validate()),
                      double.parse(servicesListData!.startLongitude.validate()))
          ...
          servicesListData!.status != IN_PROGRESS
              ? markers.add(
                  Marker(
                    ...
                    icon: sourceIcon,
                    infoWindow:
                        InfoWindow(title: servicesListData!.startAddress),
                  ),
                )
              : markers.add(
                  Marker(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
              ...
              builder: (c, snapshot) {
                if (snapshot.hasData) {
                  debugPrint(
                      "\u001B[31m Fetchorder : \u001b[35m${snapshot.data!.docs}");
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  ...
                                                  Row(
                                                    children: [
                                                      Text('${language.estAmount}:',
                                                          style: secondaryTextStyle(size: 16)),
                                                      SizedBox(width: 4),
                                                      printAmountWidget(
                                                          amount: estimatedTotalPrice.toStringAsFixed(digitAfterDecimal),
                                                          size: 14)
                                                    ],
                                                  ),
                                                ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            //           children: [
                            //             Icon(
                            //               !servicesListData!.terminus.isEmptyOrNull ? Icons.airplanemode_on : !servicesListData!.outstationcity.isEmptyOrNull?Icons.location_city:!servicesListData!.totalhour.isEmptyOrNull?Icons.hourglass_bottom:Icons.speed_rounded,
                            //             ),
                            //             SizedBox(
                            //                 width: 4),
                            //             Text(
                            //                 !servicesListData!.terminus.isEmptyOrNull ? "Airport Trip" :!servicesListData!.outstationcity.isEmptyOrNull?"Outstation Trip":!servicesListData!.totalhour.isEmptyOrNull?"Hourly Trip":"KM Based",
                            //                 maxLines: 1,
                            //                 overflow: TextOverflow.ellipsis,
                            //                 style: boldTextStyle(size: 14)),
                            //           ],
                            ...
                            //       ],
                            //     ),
                            //     !servicesListData!.terminus.isEmptyOrNull || !servicesListData!.outstationcity.isEmptyOrNull || !servicesListData!.totalhour.isEmptyOrNull ?
                            //     Column(
                            //       mainAxisAlignment:
                            //       MainAxisAlignment.spaceBetween,
                            //       crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            //             height: 8),
                            //         Text(
                            //             !servicesListData!.terminus.isEmptyOrNull ? (servicesListData!.terminus??"N/A"):!servicesListData!.outstationcity.isEmptyOrNull?(servicesListData!.outstationcity??"N/A"):!servicesListData!.totalhour.isEmptyOrNull?'Duration : ${servicesListData!.totalhour} Hrs':"KM Based",
                            //             maxLines: 1,
                            //             overflow: TextOverflow.ellipsis,
                            //             style: boldTextStyle(size: 14)),
                            //         Text(
                            //             !servicesListData!.terminus.isEmptyOrNull ? '(Fl.No:${(servicesListData!.flightnumber??"")})':!servicesListData!.outstationcity.isEmptyOrNull?(servicesListData!.triptype??"N/A"):'',
                            //             maxLines: 1,
                            //             overflow: TextOverflow.ellipsis,
                            //             style: boldTextStyle(size: 14)),
                            //       ],
                                                ...
                                                children: [
                                                  if (extraChargeAmount !=
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                            '${language.extraCharges} : ',
                                                            style:
                                                            secondaryTextStyle(color: Colors.green)),
                                                        printAmountWidget(
                                                            amount:
                                                            '${extraChargeAmount.toStringAsFixed(digitAfterDecimal)}',
                                                            size:
                                                            14,
                                                            color:
                                                            Colors.green,
        ...
        bottomNavigationBar: Container(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                icon: _buildGradientIcon(
                    Icons.book_online, 'Rides', 1),
                label: '',
              ),
              BottomNavigationBarItem(
                icon: _buildGradientIcon(
                    Icons.local_taxi, 'Vehicle', 2),
                label: '',
              ),
              BottomNavigationBarItem(
                icon: _buildGradientIcon(
                    Icons.settings, 'Settings', 3),
                label: '',
              ),
            ],
          ),
  ...
  Widget _buildGradientIcon(IconData icon, String label, int index) {
    return Column(
        ...
        ShaderMask(
          shaderCallback: (rect) => LinearGradient(
            colors: _selectedIndex == index
                ? [Colors.green, Colors.blue] // Gradient for selected item
                : [Colors.black, Colors.black],
            // Gradient for unselected item
          ...
          child: Icon(
            icon,
            size: 30.0,
            color: Colors.white, // Apply gradient to icon
          ),
        ),
        ShaderMask(
          shaderCallback: (rect) => LinearGradient(
          ...
          child: Text(
            ...
            style: TextStyle(
              fontSize: 12.0,
              color: Colors.white, // Apply gradient to text
            ),
          ),
        ),
      ],
  ...
  Widget topWidget() {
    return Row(
      ...
      children: [
        ...
        //         borderRadius: BorderRadius.circular(defaultRadius),
        //         border:
        //             Border.all(color: isOnLine ? Colors.green : Colors.red)),
        //     child: Row(
        //       mainAxisAlignment: MainAxisAlignment.center,
        //       mainAxisSize: MainAxisSize.min,
        //       children: [
            ...
            child: Row(
              ...
              children: [
                isOnLine
                    ...
                    : ImageIcon(AssetImage(ic_red_car),
                        color: Colors.red, size: 30),
                SizedBox(width: 8),
                isOnLine
                    ? ImageIcon(AssetImage(ic_green_car),
              ...
              children: [
                ...
                Text(
                    servicesListData!.status == IN_PROGRESS &&
                            ...
                            servicesListData!.multiDropLocation!
                                    .where(
                                        (element) => element.droppedAt == null)
                                    .length >
                                1
                        ? language.updateDrop
            ...
            onTap: () async {
              if (await checkPermission()) {
                if (servicesListData!.status == ACCEPTED ||
                    servicesListData!.status == BID_ACCEPTED) {
                  showConfirmDialogCustom(
                      primaryColor: primaryColor,
                  ...
                  if (servicesListData!.multiDropLocation != null &&
                          servicesListData!.multiDropLocation!.isNotEmpty &&
                          servicesListData!.multiDropLocation!
                                  .where((element) => element.droppedAt == null)
                                  .length >
                              1
                      // servicesListData!.multiDropLocation!.any((element) => element.droppedAt == null)
                      ) {
                    for (int i = 0;
                        i < servicesListData!.multiDropLocation!.length;
                        i++) {
                      if (servicesListData!.multiDropLocation![i].droppedAt ==
                          null) {
                        await dropOupUpdate(
                                rideId: '${servicesListData!.id}',
                                dropIndex:
                                    '${servicesListData!.multiDropLocation![i].drop}')
                            .then(
                          (v) {
                            servicesListData!.multiDropLocation![i].droppedAt =
          ...
          AppButtonWidget(
            ...
            onTap: () {
              showOnlyDropLocationsDialog(
                  context: context,
                  multiDropData: servicesListData!.multiDropLocation!);
            },
          )
      ],
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(language.bid_for_ride,
                                  ...
                                  Expanded(
                                    child: AppButtonWidget(
                                      ...
                                      textStyle:
                                          boldTextStyle(color: Colors.white),
                                      onTap: () async {
                                        num x = num.tryParse(estimatedTotalPrice
                                                    .toString())!
                                                .round() ??
                                            0;
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          try {
                                                                            num x =
                                                                                num.tryParse(bidAmountController.text.toString()) ?? 0;
                                                                            if (x >
                                                                                0) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(language.bid_under_review,
                              style: primaryTextStyle(
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 16),
                          child: Text(language.bid_under_review_note,
                              style: secondaryTextStyle()),
                        ),
                        Padding(
                        ...
                        SizedBox(height: 8),
                        if (bidData!.notes != null &&
                            bidData!.notes!.isNotEmpty)
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 16),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
