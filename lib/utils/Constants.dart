...
//region App name
const mAppName = 'Green Drive Captain';
//endregion
...
/*LIVE-URL*/
const DOMAIN_URL =
    'https://greendrivecabs.in'; // Don't add slash at the end of the url
//endregion

//region Google map key
//
const GOOGLE_MAP_API_KEY = 'AIzaSyBo2z_z6nP3w6ZbLZ0lMmMKO_qW1VNrmFo';
//endregion
...
const mOneSignalAppIdRider = '3943abf3-ce64-444b-8fdd-639af3cc1b8a';
const mOneSignalRestKeyRider =
    's_v2_app_hfb2x46omrcexd65monphta3rkbntxidfbde43vwobejnlmrhjy6dzytyl74im63wpi5jp76jebyblqglrekar5wmsuhxg7wlgkmv3y';

const mOneSignalAppIdDriver = '96824e00-8b1a-4503-acec-82cf3c06ebf3';
const mOneSignalRestKeyDriver =
    'os_v2_app_s2be4aeldjcqhlhmqlhtybxl6pujetfohuyusam6xh6zrfct3qrm5h6djkpxvsowh7ugkirnuvtc7akmrmnradf76cp5tc6svyfqelq';

// const mOneSignalAppIdDriver = 'YOUR_ONESIGNAL_APP_ID';
// const mOneSignalRestKeyDriver = 'YOUR_ONESIGNAL_REST_KEY';
//
// const mOneSignalAppIdRider = 'YOUR_ONESIGNAL_APP_ID';
// const mOneSignalRestKeyRider = 'YOUR_ONESIGNAL_REST_KEY';
//endregion
